...
final class DefaultDocument extends PlainDatabase implements Document{
    ...
    * issued <code>Map</code>. The properties provided can be 
    * overridden without affecting the containers database.
    * 
    * @param template template object used to generate output
    * @param binding properties used to configure the output 
    */
   public DefaultDocument(Template template, Map binding){
    ...
    *
    * @param out the output to write the template rendering to
    * @param charset the charset used to render the template 
    *
    * @throws Exception thrown if there is a problem parsing or 
    * emitting the template 
    */   
    ...
    *
    * @param out the output to write the template rendering to
    * @param binding the data to use to render the template
    *
    * @throws Exception thrown if there is a problem parsing or 
    * emitting the template 
    */  
   private void write(Writer out, Map binding) throws Exception {
