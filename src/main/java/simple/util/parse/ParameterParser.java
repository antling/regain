 ...
 */
public class ParameterParser extends Parser implements Parameters{
   ...
   /**
    * This stores the original text parsed by this instance.
    */
   ...
   /**
    * This is used so that the original text can be remembered.
    * Because the <code>toString</code> is required to be
    * implemented by the <code>Parameters</code> as returning
    * the original application/x-www-form-urlencoded format.
    * This will delegate to the super class method.
    *
    * @param text the text that is parsed by this instance
    */
   ...
   /**
    * This will return the proper encoding of the parameters 
    * in <code>application/x-www-form-urlencoded</code>. If 
    * there are no parameters then this will return "".
    *
    * @return returns the encoded form of the parameters 
    */
   ...
   private class Token {
       ...
       * this will return <code>null</code> for the token value.
       *
