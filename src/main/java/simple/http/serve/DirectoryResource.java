/*
 * DirectoryResource.java February 2001
 *
 ...
 * the <code>Resource</code> more flexibility across platforms. 
 ...
 */ 
final class DirectoryResource extends IndexedResource {     
 
   /**
    * Constructs a HTML <code>Resource</code> to represent the path
    ...
    */
   public DirectoryResource(Context context, String target) { 
