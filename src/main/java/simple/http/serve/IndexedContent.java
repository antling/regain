 ...
 */ 
public abstract class IndexedContent implements Content, Indexable {
    ...
    * is no specified locale for this <code>Content</code>.
    * <p>
    ...
    *
    * @param locale the locale for this <code>Content</code> 
    */    
    ...
    *
    * @param name the name for this <code>Content</code>
    */ 
