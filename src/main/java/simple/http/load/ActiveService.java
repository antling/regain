/*
 * ActiveService.java November 2002
 *
...
/**
 * The <code>ActiveService</code> is used to exploit the asynchronous
 ...
 */
public abstract class ActiveService extends BasicService {

   /**
    * Constructor for the <code>ActiveService</code> is used so
    ...
    * <code>Response</code> objects are given to the abstract 
    * <code>process</code> method where they can be processed.
    * <p>
    * The <code>Service.handle</code> can be implemented without 
    * risk of unhandled <code>Exception</code>'s as they can be 
    * handled by the <code>handle(Request,Response,int)</code>
    * method of the <code>BasicResource</code>.
    *
